            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-success m-r-5" onclick="enableBusiness(${business.id})" href="#!"><i
                                            class="mdi mdi-check"></i> 启用</a>
                                    <a class="btn btn-warning m-r-5" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a>
                                    <a class="btn btn-danger" onclick="batchDeletBusiness(${business.id})" href="#!"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${business.status==1}">
                                                        <font class="text-success">营业</font>
                                                    </c:if>
                ...
                <div>
                    ...
                    <div style="display: flex">
                        <ul class="pagination">
                            <li class="active" id="home_page" onclick="home(1)"><a href="#!">首页</a></li>
                            <li class="active" id="up" onclick="paging(1)"><a href="#!">上一页</a></li>
                            <div id="skip_box">
                            </div>

                            <li class="active" id="down" onclick="paging(2)"><a href="#!">下一页</a></li>
                            <li class="active" id="nohome" onclick="home(2)"><a href="#!">尾页</a></li>
                        </ul>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function batchDeletBusiness() {
        ...
        if (checkedIds.length > 0) {
            // TODO 走异步请求
            $.ajax({
                url: "${ctx}/api/business/batchDeletBusiness",
                type: "post",
                dataType: "json",
                data: {
                    id: checkedIds
    ...
    function addBusiness() {
        ...
        document.getElementById("mima").setAttribute("style", "display: block");

    }

    function editBusiness(id) {
        type = 2;
        document.getElementById("mima").setAttribute("style", "display: none");
        document.getElementById("businessForm").reset();//重置表单
        $.ajax({
